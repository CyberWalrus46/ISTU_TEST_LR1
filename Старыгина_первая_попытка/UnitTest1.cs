    ...
    public class UnitTest1
    {
        ...
        public class ArrayProcessorTests
        {
            ...
            public void TransformArray_ValidInput_ReturnsExpectedResult()
            {
                ...
                long expectedProduct = 0; // Product of -3, -2, -1
            ...
            [Fact]
            public void TransformArray_NullInput_ReturnsError2()
            {
                int[] input = { -3, -2, 0, 0, 1, 2, 3 };
                var expectedArray = new int[] { 4, -2, 4, 0, 1, 2, 3 };
                long expectedProduct = 0; // Product of -3, -2, -1
                List<string> expectedErrors = new List<string> { "Input array is null." };
